...
var controller = {
    ...
    getTopics: function(req, res) {
        ...
        // Cargar la lbreria de paginación en la clase (en el Modelo)
        ...
        Topic.paginate({}, options, (err, topics) => {
            ...
            // Devolver resultado(topics, total de topic, tota e paginas)
            return res.status(200).send({
                status: 'success',
                topics: topics.docs,
